...
- 划词搜索和图片搜索支持在设置页选择常用预设搜索源，也可以继续使用自定义链接。
- 修复搜索源下拉选择后右键菜单仍沿用旧链接的问题。
- 搜索链接输入框增加保存按钮，手动改链接后可立即保存并生效。
...
- GitHub 官方下载：[lite_tools_v4.zip](https://github.com/yun-xiao1/lite-tools/releases/download/v2.33.19/lite_tools_v4.zip)
- SHA256 校验：[lite_tools_v4.zip.sha256](https://github.com/yun-xiao1/lite-tools/releases/download/v2.33.19/lite_tools_v4.zip.sha256)

备用下载：

- 镜像 1：[gh.llkk.cc](https://gh.llkk.cc/https://github.com/yun-xiao1/lite-tools/releases/download/v2.33.19/lite_tools_v4.zip)
- 镜像 2：[gh-proxy.com](https://gh-proxy.com/https://github.com/yun-xiao1/lite-tools/releases/download/v2.33.19/lite_tools_v4.zip)
